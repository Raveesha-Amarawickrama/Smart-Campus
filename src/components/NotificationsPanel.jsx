...
const ICOLS  = { success: 'var(--success)', error: 'var(--danger)', info: 'var(--teal)', warning: 'var(--gold)' };
      ...
      <div className="sheet" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="sheet-hdr">
          ...
          <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
            <button
              ...
              style={{ fontSize: 12, fontWeight: 700, color: 'var(--teal)', minHeight: 44, padding: '0 8px' }}
            >
              Mark all read
            </button>
        ...
        <div style={{ padding: '0 20px 24px' }}>
          {notifications.length === 0 ? (
            ...
            <div key={n.id} className="notif-item" style={{ opacity: n.read ? 0.7 : 1 }}>
              <div className="notif-icon" style={{ background: COLORS[n.type] || COLORS.info }}>
                <Icon name={ICONS[n.type] || 'bell'} size={16} color={ICOLS[n.type] || ICOLS.info} />
              </div>
              <div style={{ flex: 1 }}>
