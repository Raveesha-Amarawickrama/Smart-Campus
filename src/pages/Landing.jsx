  ...
  return (
    <div className="lp">
      ...
      <section className="lp-hero">
        ...
        <div className="lp-hero-body">
          ...
          <p className="lp-hero-p">
            Manage your schedule, prioritize assignments, track credit progress, and capture lecture notes - all packed into one seamless interface.
          </p>
      ...
      <section className="lp-sec">
        ...
        <p className="lp-sec-sub">Every feature you need to dominate your curriculum, packed into one seamless interface.</p>

        {[
          {
            icon: 'dashboard', iconCls: 'feat-icon-navy',
            title: 'Unified Dashboard',
            desc: "Your academic command center. View upcoming classes, grade trends, and urgent tasks at a single glance.",
            bullets: ['Live lecture schedule', 'Weather & campus info'],
          },
          {
            icon: 'assignments', iconCls: 'feat-icon-gold',
            title: 'Assignment Tracker',
            desc: 'Never miss a deadline. Automatic reminders and priority tagging keep you ahead of the curve.',
            bullets: ['AI-powered prioritization', 'Sync with Canvas/Blackboard'],
          },
          {
            icon: 'camera', iconCls: 'feat-icon-teal',
            title: 'Notes Capture',
            desc: 'Live audio-to-text transcription for every lecture. Organise by subject automatically.',
          },
          {
      ...
      <section style={{padding:'0 20px 28px'}}>
        <div className="lp-preview">
          <div style={{position:'relative',zIndex:1}}>
            ...
            <div className="lp-preview-sub">Four powerful modules working together to keep you on top of your academic game.</div>
      ...
      <section className="lp-join">
        <div className="lp-join-avatars">
          {['A','B','C','D'].map((l,i) => (
            <div key={l} className="lp-join-av" style={{zIndex:4-i, background: i%2===0 ? 'linear-gradient(145deg,#2A4F82,#0F2240)' : 'linear-gradient(145deg,#298CBD,#1a6e98)'}}>{l}</div>
          ))}
        </div>
        <div className="lp-join-num">Join With Us</div>
        <div className="lp-join-sub">Connect with classmates and share resources securely on Smart Campus.</div>

      
        <div className="lp-testimonial">
          <div className="lp-quote-mark">"</div>
          <p className="lp-quote">
            Smart Campus didn't just organise my schedule; it fundamentally changed how I approach my degree. It's the digital backbone of my academic career.
          </p>
          <div className="lp-author">
            <div className="lp-author-av">A</div>
            <div>
