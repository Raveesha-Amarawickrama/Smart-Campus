export const DEFAULT_SCHEDULE = [
  { id: 's1', course: 'Advanced Data Structures', room: 'Hall 302', dept: 'Software Engineering', time: '09:00 AM', end: '10:30 AM', day: 'Mon,Wed,Fri' },
  { id: 's2', course: 'Cloud Computing',          room: 'Hall B',   dept: 'Software Engineering', time: '11:30 AM', end: '01:00 PM', day: 'Mon,Wed,Fri' },
  ...
  { id: 's5', course: 'Software Evaluation',      room: 'Room 110', dept: 'Software Engineering', time: '11:00 AM', end: '12:30 PM', day: 'Mon,Wed,Fri' },
];
...
export const DEFAULT_COURSES = [
  ...
  },
  {
    ...
    courses: [
      ...
      { id: 'c11', name: 'HIST 101 - ',      credits: 4, grade: 'B',  type: 'Elective' },
    ]
  },
];

export const GRADE_POINTS = { 'A+':4.0,'A':4.0,'A-':3.7,'B+':3.3,'B':3.0,'B-':2.7,'C+':2.3,'C':2.0,'C-':1.7,'D':1.0,'F':0 };
